...
import 'package:mobile/modul10/model/game.dart';
import 'package:mobile/modul10/viewmodel/fetchgame.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: [
              _searchBar(), // Search Bar di bagian atas
              const SizedBox(height: 10), // Jarak ke ListView
              FutureBuilder<List<Game>>(
                future: fetchGames(), // memanggil API
